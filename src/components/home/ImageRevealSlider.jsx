...
export const ImageRevealSlider = () => {
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 flex flex-wrap items-center justify-between gap-4 mb-6 bg-zinc-900/80 backdrop-blur-md p-3.5 rounded-2xl border border-zinc-800 shadow-xl">
      ...
      <div
        ...
        className="relative w-full aspect-[16/9] md:aspect-[21/9] max-h-[640px] rounded-3xl overflow-hidden border border-zinc-700 shadow-2xl bg-zinc-950 cursor-ew-resize focus:outline-none focus:ring-2 focus:ring-zinc-400 transition-shadow z-10"
      >
        ...
        <div className="absolute top-4 right-4 pointer-events-none z-10">
          <span className="px-2.5 py-1 rounded-md bg-black/70 backdrop-blur-md border border-zinc-600 text-[11px] font-mono font-semibold text-zinc-200 tracking-wider">
            MASTER GRADE • 2.40:1
          </span>
        </div>
        ...
        >
          {/* Full-height glowing divider line */}
          <div className="absolute top-0 bottom-0 w-0.5 bg-white shadow-[0_0_15px_rgba(255,255,255,0.8)]" />
          ...
          <div className="relative z-10 w-12 h-12 rounded-full bg-black/90 backdrop-blur-xl border-2 border-white shadow-2xl flex items-center justify-center group hover:scale-110 active:scale-95 transition-transform pointer-events-auto">
            ...
            <div className="absolute inset-0 rounded-full border border-white/50 animate-ping pointer-events-none opacity-40" />
          </div>
        </motion.div>
        ...
        <AnimatePresence>
          {showMetadata && (
            ...
            >
              <div className="max-w-xl mx-auto w-full bg-zinc-900/90 border border-zinc-700 rounded-2xl p-6 shadow-2xl">
                <div className="flex items-center justify-between mb-4 border-b border-zinc-800 pb-3">
                  ...
                  <button
                    ...
                    className="text-zinc-400 hover:text-white text-xs font-mono px-2 py-1 bg-zinc-800 rounded-md cursor-pointer border border-zinc-700"
                  >
                    ESC / Close
                  </button>
                </div>
      ...
      <div className="relative z-10 mt-6 flex flex-wrap items-center justify-between gap-4 text-xs text-zinc-400">
        ...
        <div className="flex flex-wrap items-center gap-2">
          ...
          <button
            onClick={() => jumpTo(0.02)}
            className="px-3 py-1.5 rounded-xl bg-zinc-900 border border-zinc-800 hover:border-zinc-500 hover:text-white transition-all cursor-pointer"
          >
            0% RAW Flat [1]
          </button>
          <button
            onClick={() => jumpTo(0.5)}
            className="px-3 py-1.5 rounded-xl bg-zinc-900 border border-zinc-800 hover:border-zinc-500 hover:text-zinc-200 transition-all cursor-pointer"
          >
            50/50 Split [R]
          </button>
          <button
