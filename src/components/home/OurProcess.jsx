    ...
    setTimeout(() => {
      ...
      processSteps.forEach((_, index) => {
        setTimeout(
          ...
          index * 2000 + 1000,
        ); // Ultra slow: Start after 24s, then every 72s
      });
      ...
      <div className="container mx-auto px-6 sm:px-8 lg:px-12 relative z-10">
        ...
        <div className="relative max-w-7xl mx-auto">
          ...
          <div
            ...
            style={{
              boxShadow:
                "0 25px 50px rgba(0,0,0,0.5), inset 0 2px 0 rgba(255,255,255,0.05)",
            }}
          >
            ...
            <div className="relative py-6 px-8 overflow-hidden h-64 max-w-full">
              ...
              >
                ...
                {/* Start frame */}
                <div
                  className="flex-shrink-0 w-80 h-52 bg-gray-800 rounded-lg border-2 border-gray-700 opacity-60 flex items-center justify-center"
                ...
                {processSteps.map((step, index) => (
                  ...
                  >
                    ...
                    <div className="relative h-full p-6 flex flex-col justify-between">
                      {/* Frame Number Badge */}
                      <div
                        className="absolute -top-4 -left-4 w-12 h-12 bg-foreground text-background rounded-full flex items-center justify-center font-black z-10 border-3 border-white text-lg"
          ...
          {activeFrame >= 0 && (
            <div className="absolute inset-0 pointer-events-none">
              <div
                ...
                style={{
                  background:
                    "radial-gradient(circle, rgba(255,255,255,0.9) 0%, rgba(255,255,255,0.4) 20%, rgba(255,255,0,0.2) 40%, transparent 60%)",
          ...
          <div className="relative max-w-6xl mx-auto">
            ...
            <div className="mt-6 text-center">
              <p className="text-sm text-muted-foreground italic">
                "Diverse scenarios, characters, and styles — all generated
                through our AI pipeline"
              </p>
            </div>
          </div>
        </div>
