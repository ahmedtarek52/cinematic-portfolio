...
const GridMotion = ({ items = [], gradientColor = 'black' }) => {
  ...
  return (
    <div className="grid-motion-noscroll" ref={gridRef}>
      <section
              ...
              {[...Array(7)].map((_, itemIndex) => {
                ...
                return (
                  <div key={itemIndex} className="grid-motion-row__item">
                    <div className="grid-motion-row__item-inner" style={{ backgroundColor: '#111' }}>
                      {typeof content === 'string' && (content.startsWith('http') || /^\/.+\.(webp|png|jpe?g|gif|svg|avif)$/i.test(content)) ? (
                        <div
